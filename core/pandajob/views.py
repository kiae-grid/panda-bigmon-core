...
from .models import PandaJob, Jobsactive4, Jobsdefined4, Jobswaiting4, \
    Jobsarchived4, Jobsarchived, jobs_nosql
...
def jobList(request, mode=None, param=None):
    ...
    print "Jobsdefined"
    print Jobsdefined4.objects.filter(**query)[:JOB_LIMIT].values()
    print "jobs"
    print jobs
    
    cassandra_jobs = jobs_nosql.objects.all()
    print cassandra_jobs
